...
public class FrRelatorioNFe extends javax.swing.JInternalFrame {

    //CONTROLE DE VERSÃO
    String versao = "1.0-21.0611.0";

    FDErroOcorrido fdErroOcorrido;

    private FDBuscaEmp FDBuscaEmp;

    public FrRelatorioNFe() {
        initComponents();
        title = "Relatório de NF-e - V" + versao;
    ...
    private void initComponents() {
        ...
        jPanel1.add(BtBusca, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 90, -1));

        EdNomeEmp.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Nome empresa:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.BELOW_TOP, new java.awt.Font("Tahoma", 0, 10))); // NOI18N
        ...
        jPanel1.add(JDcDataFinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 140, -1));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 200, 70, -1));

        jTabbedPane1.addTab("Relatório Integrações", jPanel1);

        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 310, 270));
        ...
        if (JDcDataInicial.getDate() == null || JDcDataFinal.getDate() == null) {
            ...
            try {
                ...
                try {
                    ...
                    JasperPrint print = JasperFillManager.fillReport("\\\\C:\\Hardsearch\\MyReports\\relDivergeNfe.jasper", map, con);
