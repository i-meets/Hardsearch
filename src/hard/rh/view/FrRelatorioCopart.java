...
public class FrRelatorioCopart extends javax.swing.JInternalFrame {
    ...
    public FrRelatorioCopart() {
        initComponents();
        title = "Relatórios de Parcelas - V" + versao;
    ...
    private void initComponents() {
        ...
        CbxAgrupaPar = new javax.swing.JCheckBox();
        ...
        jPanel1.add(CbxNPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, -1, -1));
        ...
        jPanel1.add(CbxPago, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, -1, -1));

        CbxAgrupaPar.setText("Agrupar parcelas");
        jPanel1.add(CbxAgrupaPar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, -1, -1));
        ...
        if (CbxNPago.isSelected()) {//RELATÓRIO DE PARCELAS NÃO PAGAS
            ...
            if (EdCodFuncio.getText().equals("")) {//SE FOR EMITIR O RELATÓRIO SEM O CÓDIGO DE FUNCIONÁRIO
                ...
                if (JDcDataFinal.getDate() == null || JDcDataInicial.getDate() == null) {
                    ...
                    try {
                        ...
                        String statusPar = "2";
                        String descFiltrosPar = "Listagem de Parcelas Não Pagas";

                        try {
                            map.put("FiltroStatusPar", statusPar);
                            map.put("DescFiltrosPar", descFiltrosPar);
                            JasperPrint print = JasperFillManager.fillReport("\\\\C:\\Hardsearch\\MyReports\\relParcela.jasper", map, con);
                    ...
                    if (CbxAgrupaPar.isSelected()) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                JasperPrint print = JasperFillManager.fillReport("\\\\C:\\Hardsearch\\MyReports\\relParcelaNPagaForDateGroup.jasper", map, con);
                                JasperViewer.viewReport(print, false);
                            } catch (JRException ex) {
                                fdErroOcorrido = new FDErroOcorrido(null, true);
                                fdErroOcorrido.LbInformaErro.setText("arquivo não encontrado");
                            ...
                            fdErroOcorrido = new FDErroOcorrido(null, true);
                            fdErroOcorrido.LbInformaErro.setText("gerar relatório parcela agrupada");
                            FDErroOcorrido.TaCodigoErro.setText(ex.toString());
                            fdErroOcorrido.setVisible(true);
                            Logger.getLogger(FrMenuDP.class.getName()).log(Level.SEVERE, null, ex);
                        }
                ...
                try {
                    ...
                    Integer statusPar = 1;
                    String DescFiltroPar = "Listagem de parcelas não pagas";

                    map.put("FiltroCodFuncio", codFuncio);
                    map.put("FiltroDataInicial", dateParcelaInicial);
                    map.put("FiltroDataFinal", dateParcelaFinal);
                    map.put("FiltroStatusPar", statusPar);
                    map.put("DescFiltrosPar", DescFiltroPar);
                    try {
            ...
            if (EdCodFuncio.getText().equals("")) {//SE FOR EMITIR O RELATÓRIO SEM O CÓDIGO DE FUNCIONÁRIO
                ...
                if (JDcDataFinal.getDate() == null || JDcDataInicial.getDate() == null) {
                    try {
                        ...
                        Map<String, Object> map = new HashMap<>();
                        String statusPar = "1";
                        String descFiltrosPar = "Listagem de Parcelas Pagas";
                        map.put("DescFiltrosPar", descFiltrosPar);
                        try {
                            map.put("FiltroStatusPar", statusPar);
                    ...
                    try {
                        ...
                        try {
                            ...
                            JasperPrint print = JasperFillManager.fillReport("\\\\C:\\Hardsearch\\MyReports\\relParcelaPagaForDate.jasper", map, con);
                            JasperViewer.viewReport(print, false);
                        } catch (JRException ex) {
                            fdErroOcorrido = new FDErroOcorrido(null, true);
                            fdErroOcorrido.LbInformaErro.setText("arquivo não encontrado");
                ...
                try {
                    ...
                    Integer statusPar = 2;
                    String DescFiltroPar = "Filtros: Listagem de parcelas pagas, " + codFuncio + ", Data " + dateParcelaInicial + " a " + dateParcelaFinal;
            ...
            if (EdCodFuncio.getText().equals("")) {//SE FOR EMITIR O RELATÓRIO SEM O CÓDIGO DE FUNCIONÁRIO
                ...
                try {
                    ...
                    Map<String, Object> map = new HashMap<>();
                    String statusPar = "1 OR 2";
                    String DescFiltroPar = "Listagem de parcelas pagas e não pagas";
    ...
    private javax.swing.JCheckBox CbxAgrupaPar;
